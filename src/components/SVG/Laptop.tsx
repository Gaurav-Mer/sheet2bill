...
export const MaleProfileSvg = () => {
    return (
        <svg width="40px" height="40px" viewBox="-2.28 0 66.3577 66.3577" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
